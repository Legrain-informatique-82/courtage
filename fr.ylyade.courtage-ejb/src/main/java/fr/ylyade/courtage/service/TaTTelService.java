...
import fr.ylyade.courtage.model.mapper.TaTTelMapper;
import fr.ylyade.courtage.service.interfaces.remote.ITaTTelServiceRemote;


/**
 * Session Bean implementation class TaTTelBean
 */
@Stateless
...
public class TaTTelService extends AbstractApplicationDAOServer<TaTTel, TaTTelDTO> implements ITaTTelServiceRemote {
	...
	public void remove(TaTTel persistentInstance) throws RemoveException {
		try {
			dao.remove(findById(persistentInstance.getIdTTel()));
