...
import fr.ylyade.courtage.droits.dao.IRoleDAO;
import fr.ylyade.courtage.droits.model.TaRole;
import fr.ylyade.courtage.droits.model.dto.TaRoleDTO;
import fr.ylyade.courtage.droits.model.mapper.TaRoleMapper;
...
public class TaRoleService extends AbstractApplicationDAOServer<TaRole, TaRoleDTO> implements ITaRoleServiceRemote {
	...
	public void remove(TaRole persistentInstance) throws RemoveException {
		try {
			dao.remove(findById(persistentInstance.getIdRoles()));
