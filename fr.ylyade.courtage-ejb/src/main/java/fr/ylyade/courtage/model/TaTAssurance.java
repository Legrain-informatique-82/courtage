...
@Entity
@Table(name = "ta_t_assurance")
public class TaTAssurance implements Serializable {

	private static final long serialVersionUID = -372527691651662355L;
	
	private int idTAssurance;
	...
	@Column(name = "id_t_assurance", unique = true, nullable = false)
	public int getIdTAssurance() {
		return idTAssurance;
	}

	public void setIdTAssurance(int idTAssurance) {
