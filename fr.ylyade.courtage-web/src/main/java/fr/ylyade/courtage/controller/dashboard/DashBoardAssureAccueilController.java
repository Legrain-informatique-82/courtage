...
@Named
@ViewScoped  
public class DashBoardAssureAccueilController implements Serializable {  

	/**
	 * 
	 */
	private static final long serialVersionUID = -6971876530077398527L;
...
//	private TaTGroupeTarifDTO taTGroupeTarifDTO;
	...
	public DashBoardAssureAccueilController() {  
		//values = getValues();
	}  
